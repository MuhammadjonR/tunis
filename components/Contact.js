  ...
  return (
    <SectionContainer id="contact">
      <div className="w-full">
        ...
        <SectionTitle
          bigTitle={"contact"}
          colorTitle={"BOG'LANISH"}
          normalTitle={"BIZ BILAN"}
        />
        {/* Section Title Ends */}
        <div className="xl:max-w-1140 custom-md-3:max-w-[calc(100%-195px)] lg:max-w-960 md:max-w-720 sm:max-w-540 xs:max-w-full mx-auto">
          <div className="flex down-lg:flex-col">
            ...
            <div className="w-1/3 down-lg:w-full px-16 xs:px-0">
              ...
              Menga bemalol murojaat qilishingiz mumkin. Men har doim yangi loyihalar, 
              ijodiy g'oyalar yoki sizning tasavvurlaringizning bir qismi bo'lish imkoniyatlarini muhokama qilishga tayyorman.
              </p>
                ...
                <div className="flex flex-wrap font-normal">
                  ...
                  <div className="from-sm:w-1/3 down-sm:w-full px-16 xs:px-0">
                    <input
                      ...
                      onChange={(e) => onChange(e)}
                      value={email}
                      placeholder="EMAIL MANZILINNGIZ"
                    />
                  </div>
                  <div className="from-sm:w-1/3 down-sm:w-full px-16 xs:px-0">
                    <input
