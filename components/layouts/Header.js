...
const Header = () => {
  const menus = [
    { id: 1, title: "Asosiy", href: "home", icon: "fa fa-home" },
    { id: 2, title: "Men haqimda", href: "about", icon: "fa fa-user" },
    ...
    >
      ...
      >
        {menus.map((menu) => (
          <li
            key={menu.id}
            className={`desktop-nav-element cursor-pointer w-50 h-50 relative flex items-center transition duration-300 my-20 mx-0 rounded-full ${
