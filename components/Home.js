    ...
    <SectionContainer id="home">
      ...
      <div className="flex items-center h-screen w-full down-lg:mx-auto down-lg:justify-center xs:text-left down-lg:text-center ">
        ...
        <img
          ...
          src={authorImage ? authorImage : "assets/img/projects/1rasm.jpg"}
          alt=""
        />
        {/* Desktop Image Ends */}
        <div className="from-lg:ml-100/3 from-lg:w-2/3">
          <div className="mx-auto max-w-550 custom-md-1:max-w-450">
            ...
            Dizayn va ijodkorlikka bo‘lgan ishtiyoqim bilan men o‘ziga xos va ta’sirchan vizuallar yaratishga intilaman &amp; 
            Mening yondashuvim – har bir dizayn o‘z hikoyasini aytib beradigan va auditoriyani jalb qiladigan tarzda estetika va maqsadni uyg‘unlashtirishdan iborat..
            </p>
            <div
              id="link-about"
